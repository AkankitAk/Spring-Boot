...
public class ChatHistoryController {
    ...
    private ResponseEntity<String> getChatHistory(@RequestParam String senderId){
        JSONObject response=chatHistoryService.getChatByUserId(Integer.parseInt(senderId));
        return new ResponseEntity<>(response.toString(),HttpStatus.OK);
    }

    @GetMapping(value = "get/conversion")
    private ResponseEntity<String> getConversionTwoUser(@RequestParam String senderId,@RequestParam String receiverId){
        JSONObject response=chatHistoryService.getConversion(Integer.parseInt(senderId), Integer.parseInt(receiverId));
        return new ResponseEntity<>(response.toString(),HttpStatus.OK);
    }
